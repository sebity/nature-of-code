...
;;;; update-ex-1-9
(defun update-ex-1-9 (loc vel acc)
  (random-2d-vectors acc)
  (mult-vectors acc (random 2))
...
(defun render-ex-1-9 ()
  ...
  (update-ex-1-9 *location* *velocity* *acceleration*)
  (check-edges-ex-1-9 *location*)
  (display-ex-1-9 *location*)
  (sdl:update-display))
...
(defun motion-101-random-acceleration ()
  (setup-ex-1-9)
  (sdl:with-init (sdl:sdl-init-video)
    (sdl:window *width* *height* :title-caption "Motion 101 (Random Acceleration)")
